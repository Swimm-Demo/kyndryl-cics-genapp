...
```mermaid
flowchart TD
    subgraph PolicyTypes [📋 POLICY TYPES & CHARACTERISTICS]
        direction TB
        CommercialPolicy[🏢 COMMERCIAL POLICY<br/>• Only policy type we process<br/>• Policy type = 'C'<br/>• Full risk assessment available]
        NonCommercialPolicy[❌ NON-COMMERCIAL POLICIES<br/>• Personal, residential, etc.<br/>• System cannot process<br/>• Requires manual handling]
    end
    
    subgraph RiskAssessment ["🎯 RISK ASSESSMENT PROCESS (LGAPDB02)"]
        direction TB
        StartRisk[📊 START: BASE SCORE = 100<br/>All commercial policies begin<br/>with 100 risk points]
        
        StartRisk --> PropertyTypeStep{🏢 STEP 1: Property Type Assessment}
        
        PropertyTypeStep -->|Factory| FactoryRisk[⚙️ FACTORY: Add +75 Points<br/>• Running total: 175]
        PropertyTypeStep -->|Warehouse| WarehouseRisk[🏭 WAREHOUSE: Add +50 Points<br/>• Running total: 150]
        PropertyTypeStep -->|Retail| RetailRisk[🛍️ RETAIL: Add +40 Points<br/>• Running total: 140]
        PropertyTypeStep -->|Office| OfficeRisk[📊 OFFICE: Add +25 Points<br/>• Running total: 125]
        PropertyTypeStep -->|Other Commercial| OtherRisk[🏢 OTHER: Add +30 Points<br/>• Running total: 130]
        
        
        FactoryRisk --> GeographicStep{🗺️ STEP 2: Geographic Risk Check}
        WarehouseRisk --> GeographicStep
        RetailRisk --> GeographicStep
        OtherRisk --> GeographicStep
        OfficeRisk --> GeographicStep
        
        GeographicStep -->|Postcode starts FL or CR| AddFloodRisk[🌊 FLOOD ZONE: Add +30 Points<br/>]
        GeographicStep -->|Other postcodes| StandardLocation[📍 STANDARD LOCATION<br/>• No additional geographic risk<br/>]
        
        AddFloodRisk --> CoverageValidation{💰 STEP 3: Coverage Amount Validation}
        StandardLocation --> CoverageValidation
        
        CoverageValidation -->|Any peril > $500,000| HighValueProperty[💎 HIGH VALUE PROPERTY<br/>• Large coverage amounts<br/>• Additional +15 risk points]
        CoverageValidation -->|All perils ≤ $500,000| StandardCoverage[📋 STANDARD COVERAGE<br/>• Normal coverage limits<br/>• Standard processing]
        
        HighValueProperty --> LocationRisk{🗺️ STEP 4: Location Risk Assessment}
        StandardCoverage --> LocationRisk
        
        LocationRisk -->|"Urban area (Lat/Long in city zones)"| UrbanLocation[🏙️ URBAN LOCATION<br/>• Additional +10 risk points]
        LocationRisk -->|"Rural area (Outside city zones)"| RuralLocation[🌾 RURAL LOCATION<br/>• Additional +20 risk points]
        LocationRisk -->|Suburban area| SuburbanLocation[🏘️ SUBURBAN LOCATION<br/>• Additional +5 risk points]
        
        UrbanLocation --> CustomerHistory{👤 STEP 5: Customer Risk History}
        RuralLocation --> CustomerHistory
        SuburbanLocation --> CustomerHistory
        
        CustomerHistory -->|"New customer (no history)"| NewCustomer[🆕 NEW CUSTOMER<br/>• No claims history<br/>• Additional +10 risk points]
        CustomerHistory -->|"Existing customer (good record)"| GoodCustomer[⭐ PREFERRED CUSTOMER<br/>• Clean claims history<br/>• Reduce risk by -5 points]
        CustomerHistory -->|"Existing customer (poor record)"| RiskyCustomer[⚠️ HIGH RISK CUSTOMER<br/>• Previous claims or issues<br/>• Additional +25 risk points]
        
        NewCustomer --> CompleteRiskScore[🎯 FINAL RISK SCORE<br/>All assessments complete<br/>Ready for underwriting decision]
        GoodCustomer --> CompleteRiskScore
        RiskyCustomer --> CompleteRiskScore
    end
    
    subgraph UnderwritingProcess ["⚖️ UNDERWRITING & PRICING PROCESS (LGAPDB03)"]
        direction TB
        CompleteRiskScore --> ApprovalStep{📋 STEP 6: Underwriting Decision}
        
        ApprovalStep -->|Score > 200| RejectStatus[🚫 REJECTED<br/>• High risk - manual review required<br/>• No premium calculated<br/>• Specialty underwriting needed]
        ApprovalStep -->|Score 151-200| PendingStatus[⏳ PENDING<br/>• Medium risk - pending review<br/>• Premium calculated for reference<br/>• Additional review required]
        ApprovalStep -->|Score ≤ 150| ApprovedStatus[✅ APPROVED<br/>• Standard risk level<br/>• Proceed to pricing<br/>• Immediate processing]
        
        ApprovedStatus --> DiscountStep{💰 STEP 7: Discount Check}
        PendingStatus --> DiscountStep
        
        DiscountStep -->|All 4 perils covered| MultiPerilRate[🎁 MULTI-PERIL DISCOUNT<br/>• 10% discount applied<br/>• Discount factor = 0.90<br/>• Comprehensive coverage reward]
        DiscountStep -->|Partial coverage| StandardRate[💵 STANDARD RATES<br/>• No discount<br/>• Discount factor = 1.00<br/>• Individual peril pricing]
        
        MultiPerilRate --> PremiumCalc[🧮 STEP 8: Calculate Premiums<br/>Fire: Risk × 0.80 × Coverage × Discount<br/>Crime: Risk × 0.60 × Coverage × Discount<br/>Flood: Risk × 1.20 × Coverage × Discount<br/>Weather: Risk × 0.90 × Coverage × Discount]
        StandardRate --> PremiumCalc
        
        PremiumCalc --> FinalOutput[📄 STEP 9: Generate Output<br/>• Customer details<br/>• Risk score & status<br/>• Individual premiums<br/>• Total premium<br/>• Approval/rejection reason]
        
        RejectStatus --> FinalOutput
    end
    
    subgraph BusinessResults [📤 PROCESSING OUTCOMES]
        direction TB
        ProcessedQuotes[✅ PROCESSED QUOTES<br/>• Approved commercial policies<br/>• Risk-based competitive pricing<br/>• Automated processing]
        
        ReviewQueue[⏳ MANUAL REVIEW QUEUE<br/>• Medium risk applications<br/>• Underwriter assessment required<br/>• Additional documentation needed]
        
        HighRiskReferrals[🚫 HIGH RISK REFERRALS<br/>• Rejected applications<br/>• Specialty underwriting required<br/>• Alternative coverage options]
        
        SystemConstraints[❌ SYSTEM LIMITATIONS<br/>• Non-commercial policies only<br/>• Manual processing required<br/>• Business expansion opportunity]
        
        QualityMetrics[📊 BATCH STATISTICS<br/>• Total records processed<br/>• Commercial vs non-commercial split<br/>• Error rates & quality tracking]
    end
    
    %% Main flow connections
    CommercialPolicy --> StartRisk
    NonCommercialPolicy --> SystemConstraints
    
    %% Results routing
    FinalOutput --> ProcessedQuotes
    FinalOutput --> ReviewQueue  
    FinalOutput --> HighRiskReferrals
    FinalOutput --> QualityMetrics
...
| <SwmToken path="/base/src/LGAPDB01.cbl" pos="78:3:3" line-data="               PERFORM P007" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`P007`</SwmToken>, <SwmToken path="/base/src/LGAPDB01.cbl" pos="88:3:3" line-data="               PERFORM P009" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`P009`</SwmToken>, <SwmToken path="/base/src/LGAPDB01.cbl" pos="110:3:3" line-data="           PERFORM P010" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`P010`</SwmToken>, <SwmPath repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp" path="/base/src/LGAPDB02.cbl">`(kyndryl-cics-genapp) base/src/LGAPDB02.cbl`</SwmPath> <SwmToken path="/base/src/LGAPDB02.cbl" pos="39:1:3" line-data="       MAIN-LOGIC." repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`MAIN-LOGIC`</SwmToken>, <SwmToken path="/base/src/LGAPDB02.cbl" pos="40:3:7" line-data="           PERFORM GET-RISK-FACTORS" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`GET-RISK-FACTORS`</SwmToken>, <SwmToken path="/base/src/LGAPDB02.cbl" pos="41:3:7" line-data="           PERFORM CALCULATE-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`CALCULATE-RISK-SCORE`</SwmToken> | RL-004  | Computation       | If the policy type is 'C' (commercial), the record is processed as a commercial policy. The processed counter is incremented. Risk factors for FIRE and CRIME are fetched from a database (defaults: FIRE <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken>, CRIME <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken> if not found). The risk score is calculated: base 100, plus property type adjustment (WAREHOUSE +50, FACTORY +75, OFFICE +25, RETAIL +40, other +30), plus 30 if postcode starts with 'FL' or 'CR'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | <SwmToken path="/base/src/LGAPDB01.cbl" pos="87:3:7" line-data="           IF IN-POLICY-TYPE = &#39;C&#39;" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`IN-POLICY-TYPE`</SwmToken> is 'C'.     | Default risk factors: FIRE <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken>, CRIME <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken>. Property type adjustments as above. Postcode prefix adjustment: +30 for 'FL' or 'CR'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| <SwmPath repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp" path="/base/src/LGAPDB03.cbl">`(kyndryl-cics-genapp) base/src/LGAPDB03.cbl`</SwmPath> <SwmToken path="/base/src/LGAPDB03.cbl" pos="45:3:5" line-data="           PERFORM CALCULATE-PREMIUMS" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`CALCULATE-PREMIUMS`</SwmToken>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | RL-007  | Computation       | Premiums for each peril are calculated as: FIRE = <SwmToken path="/base/src/LGAPDB01.cbl" pos="123:16:20" line-data="           CALL &#39;LGAPDB03&#39; USING WS-RISK-SCR, IN-FIRE-PERIL, IN-CRIME-PERIL," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`IN-FIRE-PERIL`</SwmToken> × FIRE risk factor × risk score × discount factor; CRIME = <SwmToken path="/base/src/LGAPDB01.cbl" pos="123:23:27" line-data="           CALL &#39;LGAPDB03&#39; USING WS-RISK-SCR, IN-FIRE-PERIL, IN-CRIME-PERIL," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`IN-CRIME-PERIL`</SwmToken> × CRIME risk factor × risk score × discount factor; FLOOD = <SwmToken path="/base/src/LGAPDB01.cbl" pos="124:1:5" line-data="                                IN-FLOOD-PERIL, IN-WEATHER-PERIL, WS-STAT," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`IN-FLOOD-PERIL`</SwmToken> × <SwmToken path="/base/src/LGAPDB02.cbl" pos="16:15:17" line-data="       01  WS-FLOOD-FACTOR             PIC V99 VALUE 1.20." repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`1.20`</SwmToken> × risk score × discount factor; WEATHER = <SwmToken path="/base/src/LGAPDB01.cbl" pos="124:8:12" line-data="                                IN-FLOOD-PERIL, IN-WEATHER-PERIL, WS-STAT," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`IN-WEATHER-PERIL`</SwmToken> × <SwmToken path="/base/src/LGAPDB03.cbl" pos="99:3:5" line-data="             MOVE 0.90 TO LK-DISC-FACT" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.90`</SwmToken> × risk score × discount factor. Total premium is the sum of all four. | When processing a commercial policy.                                                                                                                                                                                                                           | FIRE risk factor: from DB or <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken>; CRIME: from DB or <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken>; FLOOD: <SwmToken path="/base/src/LGAPDB02.cbl" pos="16:15:17" line-data="       01  WS-FLOOD-FACTOR             PIC V99 VALUE 1.20." repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`1.20`</SwmToken>; WEATHER: <SwmToken path="/base/src/LGAPDB03.cbl" pos="99:3:5" line-data="             MOVE 0.90 TO LK-DISC-FACT" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.90`</SwmToken>. All premiums: numeric, two decimal places, right-aligned, padded to field width (10 for each peril, 11 for total).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| Rule ID | Paragraph Name                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Rule Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RL-004  | <SwmToken path="/base/src/LGAPDB01.cbl" pos="78:3:3" line-data="               PERFORM P007" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`P007`</SwmToken>, <SwmToken path="/base/src/LGAPDB01.cbl" pos="88:3:3" line-data="               PERFORM P009" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`P009`</SwmToken>, <SwmToken path="/base/src/LGAPDB01.cbl" pos="110:3:3" line-data="           PERFORM P010" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`P010`</SwmToken>, <SwmPath repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp" path="/base/src/LGAPDB02.cbl">`(kyndryl-cics-genapp) base/src/LGAPDB02.cbl`</SwmPath> <SwmToken path="/base/src/LGAPDB02.cbl" pos="39:1:3" line-data="       MAIN-LOGIC." repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`MAIN-LOGIC`</SwmToken>, <SwmToken path="/base/src/LGAPDB02.cbl" pos="40:3:7" line-data="           PERFORM GET-RISK-FACTORS" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`GET-RISK-FACTORS`</SwmToken>, <SwmToken path="/base/src/LGAPDB02.cbl" pos="41:3:7" line-data="           PERFORM CALCULATE-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`CALCULATE-RISK-SCORE`</SwmToken> | If the policy type is 'C' (commercial), the record is processed as a commercial policy. The processed counter is incremented. Risk factors for FIRE and CRIME are fetched from a database (defaults: FIRE <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken>, CRIME <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken> if not found). The risk score is calculated: base 100, plus property type adjustment (WAREHOUSE +50, FACTORY +75, OFFICE +25, RETAIL +40, other +30), plus 30 if postcode starts with 'FL' or 'CR'.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
subgraph node3 [MAIN-LOGIC]
  ...
  sgmain_2_node2 -->|"x > 200: Rejected (Manual Review Required)"| sgmain_2_node3["Calculate premiums"]
  sgmain_2_node2 -->|"151-200: Pending (Pending Review)"| sgmain_2_node3
  sgmain_2_node2 -->|"x <= 150: Approved"| sgmain_2_node3
...
%% end
%% 
%% subgraph node3 [<SwmToken path="/base/src/LGAPDB02.cbl" pos="39:1:3" line-data="       MAIN-LOGIC." repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`MAIN-LOGIC`</SwmToken>]
%%   sgmain_2_node1["Gather risk factors"] --> sgmain_2_node2{"Risk score decision"}
...
%% end
%% 
%% subgraph node3 [<SwmToken path="/base/src/LGAPDB02.cbl" pos="41:3:7" line-data="           PERFORM CALCULATE-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`CALCULATE-RISK-SCORE`</SwmToken>]
%%   sgmain_2_node1["Set <SwmToken path="/base/src/LGAPDB02.cbl" pos="70:7:11" line-data="           MOVE 100 TO LK-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken> to 100"] --> sgmain_2_node2{"<SwmToken path="/base/src/LGAPDB02.cbl" pos="33:7:11" line-data="       PROCEDURE DIVISION USING LK-PROPERTY-TYPE, LK-POSTCODE, LK-LATITUDE," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-PROPERTY-TYPE`</SwmToken>?"}
...
%%   sgmain_2_node2 -->|"WAREHOUSE (+50)"| sgmain_2_node3["Add to <SwmToken path="/base/src/LGAPDB02.cbl" pos="74:7:11" line-data="               ADD 50 TO LK-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken>"]
%%   sgmain_2_node2 -->|"FACTORY (+75)"| sgmain_2_node3
%%   sgmain_2_node2 -->|"OFFICE (+25)"| sgmain_2_node3
%%   sgmain_2_node2 -->|"RETAIL (+40)"| sgmain_2_node3
%%   sgmain_2_node2 -->|"OTHER (+30)"| sgmain_2_node3
...
%%   sgmain_2_node3 --> sgmain_2_node4{"<SwmToken path="/base/src/LGAPDB02.cbl" pos="33:14:16" line-data="       PROCEDURE DIVISION USING LK-PROPERTY-TYPE, LK-POSTCODE, LK-LATITUDE," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-POSTCODE`</SwmToken> starts with 'FL' or 'CR'?"}
...
%%   sgmain_2_node4 -->|"Yes (+30)"| sgmain_2_node5["Add to <SwmToken path="/base/src/LGAPDB02.cbl" pos="74:7:11" line-data="               ADD 50 TO LK-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken> and return"]
%%   sgmain_2_node4 -->|"No"| sgmain_2_node6["Return <SwmToken path="/base/src/LGAPDB02.cbl" pos="31:3:7" line-data="       01  LK-RISK-SCORE               PIC 999." repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken>"]
...
%% 
%% 
%% subgraph node2 [<SwmToken path="/base/src/LGAPDB02.cbl" pos="40:3:7" line-data="           PERFORM GET-RISK-FACTORS" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`GET-RISK-FACTORS`</SwmToken>]
%%   sgmain_1_node1["Determine FIRE risk factor"]
...
%%   sgmain_1_node2 -->|"No"| sgmain_1_node4["Set FIRE factor to <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken>"]
...
%%   sgmain_1_node6 -->|"No"| sgmain_1_node8["Set CRIME factor to <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken>"]
...
%%     node2 -->|"No"| node4["Set FIRE factor to <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken>"]
...
%%     node6 -->|"No"| node8["Set CRIME factor to <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken>"]
...
%% %%{init: {"flowchart": {"defaultRenderer": "elk"}} }%%
%% flowchart TD
%%     node1["Set <SwmToken path="/base/src/LGAPDB02.cbl" pos="70:7:11" line-data="           MOVE 100 TO LK-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken> to 100"] --> node2{"<SwmToken path="/base/src/LGAPDB02.cbl" pos="33:7:11" line-data="       PROCEDURE DIVISION USING LK-PROPERTY-TYPE, LK-POSTCODE, LK-LATITUDE," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-PROPERTY-TYPE`</SwmToken>?"}
...
%%     node2 -->|"WAREHOUSE (+50)"| node3["Add to <SwmToken path="/base/src/LGAPDB02.cbl" pos="70:7:11" line-data="           MOVE 100 TO LK-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken>"]
%%     node2 -->|"FACTORY (+75)"| node3
%%     node2 -->|"OFFICE (+25)"| node3
%%     node2 -->|"RETAIL (+40)"| node3
%%     node2 -->|"OTHER (+30)"| node3
...
%%     node3 --> node4{"<SwmToken path="/base/src/LGAPDB02.cbl" pos="33:14:16" line-data="       PROCEDURE DIVISION USING LK-PROPERTY-TYPE, LK-POSTCODE, LK-LATITUDE," repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-POSTCODE`</SwmToken> starts with 'FL' or 'CR'?"}
...
%%     node4 -->|"Yes (+30)"| node5["Add to <SwmToken path="/base/src/LGAPDB02.cbl" pos="70:7:11" line-data="           MOVE 100 TO LK-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken> and return"]
%%     node4 -->|"No"| node6["Return <SwmToken path="/base/src/LGAPDB02.cbl" pos="70:7:11" line-data="           MOVE 100 TO LK-RISK-SCORE" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`LK-RISK-SCORE`</SwmToken>"]
...
%% 
%% 
%% subgraph node1 [<SwmToken path="/base/src/LGAPDB02.cbl" pos="40:3:7" line-data="           PERFORM GET-RISK-FACTORS" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`GET-RISK-FACTORS`</SwmToken>]
%%   sgmain_1_node1["Get FIRE risk factor from database"]
...
%%   sgmain_1_node2 -->|"No"| sgmain_1_node4["Use default <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken> for FIRE"]
...
%%   sgmain_1_node6 -->|"No"| sgmain_1_node8["Use default <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken> for CRIME"]
...
%%     node2 -->|"No"| node4["Use default <SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken> for FIRE"]
...
%%     node6 -->|"No"| node8["Use default <SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken> for CRIME"]
...
%%     node3 --> node5["Calculate premiums for fire (<SwmToken path="/base/src/LGAPDB02.cbl" pos="54:3:5" line-data="               MOVE 0.80 TO WS-FIRE-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.80`</SwmToken>), crime (<SwmToken path="/base/src/LGAPDB02.cbl" pos="66:3:5" line-data="               MOVE 0.60 TO WS-CRIME-FACTOR" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.60`</SwmToken>), flood (<SwmToken path="/base/src/LGAPDB02.cbl" pos="16:15:17" line-data="       01  WS-FLOOD-FACTOR             PIC V99 VALUE 1.20." repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`1.20`</SwmToken>), weather (<SwmToken path="/base/src/LGAPDB03.cbl" pos="99:3:5" line-data="             MOVE 0.90 TO LK-DISC-FACT" repo-id="Z2l0aHViJTNBJTNBa3luZHJ5bC1jaWNzLWdlbmFwcCUzQSUzQVN3aW1tLURlbW8=" repo-name="kyndryl-cics-genapp">`0.90`</SwmToken>) using discount factor"]
