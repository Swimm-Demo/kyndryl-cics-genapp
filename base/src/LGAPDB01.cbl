       ...
       01  WS-TAC-INTERFACE.
           05 WS-TAC-TRANSACTION-DATA  PIC X(100).
           05 WS-TAC-SECRET-KEY        PIC X(8) VALUE 'LGAP2024'.
           05 WS-TAC-OUTPUT            PIC X(8).
           05 WS-TAC-WORK-FIELDS.
              10 WS-TAC-CUST-NUM       PIC X(10).
              10 WS-TAC-PREMIUM-CHAR   PIC X(15).
              10 WS-TAC-RISK-CHAR      PIC X(3).
              10 WS-TAC-DATE-CHAR      PIC X(8).
       ...
       P005D-WRITE-HEADERS.
           ...
           MOVE 'TRN-CODE' TO OUT-TRANSACTION-CODE
           WRITE OUTPUT-RECORD.
       ...
       P010-PROCESS-ERROR-RECORD.
           ...
           MOVE SPACES TO OUT-TRANSACTION-CODE
           WRITE OUTPUT-RECORD
           ADD 1 TO WS-ERR-CNT.
      ...
      *    Determine underwriting decision based on enhanced criteria
       ...
       P011E-GENERATE-TAC.
           MOVE IN-CUSTOMER-NUM TO WS-TAC-CUST-NUM
           MOVE WS-TOT-PREM TO WS-TAC-PREMIUM-CHAR
           MOVE WS-BASE-RISK-SCR TO WS-TAC-RISK-CHAR
           MOVE WS-PROCESSING-DATE TO WS-TAC-DATE-CHAR
           
           STRING WS-TAC-CUST-NUM DELIMITED BY SPACE
                  WS-TAC-PREMIUM-CHAR DELIMITED BY SPACE
                  WS-TAC-RISK-CHAR DELIMITED BY SPACE
                  WS-TAC-DATE-CHAR DELIMITED BY SIZE
                  INTO WS-TAC-TRANSACTION-DATA
           
           CALL 'LGAPTAC' USING WS-TAC-TRANSACTION-DATA
                                WS-TAC-SECRET-KEY
                                WS-TAC-OUTPUT.

       P011F-WRITE-OUTPUT-RECORD.
           MOVE IN-CUSTOMER-NUM TO OUT-CUSTOMER-NUM
           MOVE IN-PROPERTY-TYPE TO OUT-PROPERTY-TYPE
           MOVE IN-POSTCODE TO OUT-POSTCODE
           ...
           MOVE WS-TAC-OUTPUT TO OUT-TRANSACTION-CODE
           WRITE OUTPUT-RECORD.
